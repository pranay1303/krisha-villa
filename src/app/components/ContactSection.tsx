...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const message = `Hi, I'm ${formData.name}. I would like to book Krisha Villa for ${formData.guests} guests on ${formData.date}. ${formData.message}`;
    const whatsappUrl = `https://wa.me/918087536077?text=${encodeURIComponent(message)}`;
            ...
            <div className="bg-[#faf5ed] rounded-2xl p-8 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+918087536077" className="text-gray-700 hover:text-[#1a4d2e] transition-colors block">
                    +91 80875 36077
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-[#1a4d2e] rounded-full flex items-center justify-center">
                  <svg className="text-[#d4af37]" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
